...
public class JavaC3Test {
    ...
    public void testDirectSuperClasses() {
        assertEquals(ImmutableList.of(AbstractSet.class, Set.class, Cloneable.class, Serializable.class),
                DefaultDirectSuperclassesInspector.INSTANCE.directParentClasses(HashSet.class));
    }

    @Test
    public void testSet() throws Exception {
        Iterable<Class<?>> linearization = JavaC3.allSuperclasses(Set.class);
        assertEquals(ImmutableList.of(Set.class, Collection.class, Iterable.class, Object.class), linearization);
    }

    @Test
    public void testAbstractSet() throws Exception {
        Iterable<Class<?>> linearization = JavaC3.allSuperclasses(AbstractSet.class);
        assertEquals(ImmutableList.of(AbstractSet.class, AbstractCollection.class, Set.class, Collection.class,
    ...
    public void testHashSet() throws Exception {
        ...
        assertEquals(
                ImmutableList.of(HashSet.class, AbstractSet.class, AbstractCollection.class, Set.class,
                        Collection.class, Iterable.class, Cloneable.class, Serializable.class, Object.class),
                linearization);
    }
    ...
    public void testPrimitives() throws Exception {
        ...
        assertEquals(
                ImmutableList.of(double.class, float.class, long.class, int.class, short.class, byte.class, char.class),
                linearization);
    ...
    public void testInheritance() {
        assertEquals(ImmutableList.of(TestC.class, TestA.class, TestB.class, Object.class),
                JavaC3.allSuperclasses(TestC.class));
        assertEquals(ImmutableList.of(TestA.class, Object.class), JavaC3.allSuperclasses(TestA.class));
        assertEquals(ImmutableList.of(TestB.class, Object.class), JavaC3.allSuperclasses(TestB.class));
        assertEquals(ImmutableList.of(Object.class), JavaC3.allSuperclasses(Object.class));
