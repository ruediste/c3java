...
/**
 * Reads direct parent types of a type. Implementations of this interface can be
 ...
 *
 */
public interface DirectParentTypesReader
{
    /**
     * Get the direct parent types
     * @param type the type to get the parent types of.
     */
    public List<Class<?>> directParentTypes
        (Class<?> type);
}